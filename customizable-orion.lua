-- Hello and welcome to my version of Orion UI library.
-- You can customize this the way you want.


-- To change the text that appears saying "Orion Library" when u boot your script
-- just type your script name down below here

yourscriptname = "Sigma Hub" -- Change Sigma Hub for your script name
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.IntroText = WindowConfig.IntroText or yourscriptname
